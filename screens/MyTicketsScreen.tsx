import {Text, View, StyleSheet, Animated, TouchableHighlight, TouchableOpacity, StatusBar} from "react-native";
...
const MyTicketsScreen = () => {
    ...
    const renderItem = (data, rowMap) => {
        ...
        return (
            <VisibleItem data={data} rowHeightAnimatedValue={rowHeightAnimatedValue}
